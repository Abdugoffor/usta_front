...
const {
  ...
  resumes,
  { name: '', search: '', region_id: '', is_active: '', category_id: '', min_experience: '' },
...
<template>
  <div class="page">
    <PageHeader :title="tt('Резюме')" :subtitle="tt('Резюме исполнителей')">
      <template #actions>
      ...
      <form @submit.prevent="submit" class="form-sections">
        ...
        <section class="form-section">
          ...
          <div class="field">
            ...
            <input class="input" v-model="form.skills" required minlength="2" :placeholder="tt('Через запятую')" />
          </div>
        </section>
